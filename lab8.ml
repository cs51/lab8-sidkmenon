...
(* .. *)
let fid = WEvent.add_listener newswire fakeNewsNetwork;;
let bid = WEvent.add_listener newswire buzzFake;;
...
(* .. *)
WEvent.remove_listener newswire fid;;
WEvent.remove_listener newswire bid;;
